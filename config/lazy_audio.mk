...
ALARM_PATH := vendor/lazy/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/lazy/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/lazy/prebuilt/common/media/audio/ringtones
