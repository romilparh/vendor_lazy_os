...
# Lineage SDK
include vendor/lazy/config/lineage_sdk_common.mk
endif
...
ifneq ($(LAZY_BUILDTYPE),)
    LAZY_VERSION := LAZY-PIE-v$(PRODUCT_VERSION)-$(shell date +%Y%m%d)-$(LAZY_BUILD)-$(LAZY_BUILDTYPE)
else
    LAZY_VERSION := LAZY-PIE-v$(PRODUCT_VERSION)-$(shell date +%Y%m%d)-$(LAZY_BUILD)-$(LAZY_BUILDTYPE)-UNOFFICIAL
endif


PRODUCT_EXTRA_RECOVERY_KEYS += \
    vendor/lazy/build/target/product/security/lazy_test
